...
const addProduct = (set: any) => async (product: createProductType) => {
  try {
    set({
      loading: true,
      error: "",
...
const loadProductList = (set: any) => async () => {
  try {
    set({ loading: true });
...
const loadProductDetails = (set: any) => async (id: string) => {
  try {
    set({ loading: true });
...
const loadEmiBySku = (set: any) => async (skuId: string, productId: string) => {
  try {
...
export const useProductManagerStore = create<ProductState>()(
  persist(
    (set) => ({
      ...
      loadProductList: loadProductList(set),
      loadProductDetails: loadProductDetails(set),
      loadEmiBySku: loadEmiBySku(set),
